    ...
    return (
        <div className='sticky top-0 left-0 z-50 font-[Poppins] py-6 text-center bg-indigo-500 lg:px-24 px-4'>
            <div className='flex items-center justify-between'>
                ...
                <ul className={`lg:flex lg:items-center lg:pb-0 pb-8 absolute lg:static bg-indigo-500 lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 pl-7 transition-all duration-500 ease-in ${open ? 'top-16 opacity-100' : 'top-[-490px] opacity-0'} lg:opacity-100`}>
                    {
                        Links.map(link => <li
